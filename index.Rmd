...
-   The App uses data from the Full Report of the 2022 Kenya Demographic and Health Survey (2022 KDHS). The survey was implemented by the Kenya National Bureau of Statistics (KNBS) in collaboration with the Kenya's Ministry of Health (MoH) and other stakeholders.
...
anc_number_county <-fread("data/table_9/table_9_2C_ancvisits_number_by_county.csv")%>%
  mutate(County=recode(County,"Elgeyo-Marakwet"="Elgeyo Marakwet", "Murang'a"="Muranga", "Tharaka-Nithi"="Tharaka Nithi", "Nairobi City"="Nairobi", "Taita/Taveta"="Taita Taveta"))%>%
  mutate(proportion_category=ifelse(Proportion<20,"<20",ifelse(Proportion>19 & Proportion<40, "20-39", "40-78")))
...
T15.10C <- T15.10C %>%
  mutate(value=abs(value)) %>%
  mutate(cat=ifelse(value<40, "<40", ifelse(value>39 & value<60, "40-59", ifelse(value>59 & value<80, "60-79", ">79"))))
