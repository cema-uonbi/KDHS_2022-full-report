...
insurance[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
occupation_county <- read.csv("data/table_3/table3_7C_occupation_by_county_2.csv")
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
occupation[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
employment[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
migration[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
#|>
  # mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
water_collector[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
#|>
#  mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
water_treat[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
#|>
#mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
excreta_mgmnt[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
excreta_mgmnt_county <- excreta_mgmnt_county |>
  mutate(cat=fifelse(Proportion<1, "<1.0", fifelse(Proportion>0.9 & Proportion<10.7, "0.9-10.6", fifelse(Proportion>10.6 & Proportion <47.8, "10.7-47.7",
                                                                                                 ">47.7"))))
...
#|>
  #mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
child_stool_disp[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
handwashing[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)]  
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
knowledge_fertile[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
fp_messages[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
```
...
antenatal_care1[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
  # mutate(Proportion=fifelse(Proportion<0.5, Proportion, round(Proportion)))
micronutrient[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
nutrition_women[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
mdd[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
iron_women[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
itn_possess <- fread("data/table_12/table12_1_ITN_possession_by_background_xtics.csv") #|>
 # mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
itn_possess[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
itn_access[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
itn_use[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
existing_itn_use[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
children_itn_use[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
#|>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
women_itn_use[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
iptp[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
mal_fever[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
mal_treat_source[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
hiv_meds_kap[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
bp[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5,round(Proportion), Proportion))
breast_cancer[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
...
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
cervical_cancer[, Proportion := fifelse(Proportion>0.5, round(Proportion), Proportion)] 
