...
renderPlot({if(input$early_childhood_mortality!="County"){ggplot(early_childhood_mortality[early_childhood_mortality$Variable%in%input$early_childhood_mortality,],aes(x=Characteristic, y=proportion, fill=category))+
  geom_bar(position="dodge", stat="identity")+
  theme_bw()+scale_fill_brewer(palette = "Set1")+
